...
void cargarArchivo(int *posicionColumnaActivo) {
  propiedad datos[15] = {
      {1, "23/12/2019", "Capital Federal", "San Cristobal", 7, 2, 140.0, 140.0, 153000.0, "USD", "Departamento", "Venta", "06/02/2020", 1},
      {2, "21/11/2019", "Capital Federal", "Boedo", 1, 2, 70, 58, 159000, "USD", "PH", "Venta", "05/01/2020", 1},
      {3, "01/11/2019", "Capital Federal", "Palermo", 1, 1, 45, 45, 125000, "USD", "Departamento", "Venta", 1},
      {4, "23/12/2019", "Capital Federal", "Palermo", 1, 1, 85, 50, 295000, "PESOS", "PH", "Alquiler", "01/04/2020", 1},
      {5, "11/03/2020", "Bs.As. G.B.A Zona Sur", "La Plata", 1, 1, 50, 35, 40000, "USD", "Casa", "Venta", "24/07/2021", 1},
      {6, "01/11/2019", "Capital Federal", "Villa Crespo", 1, 1, 56, 56, 150000, "USD", "PH", "Venta", "09/02/2020", 1},
      {7, "31/10/2019", "Capital Federal", "Villa Crespo", 1, 1, 70, 70, 159500, "USD", "Departamento", "Venta", "", 1},
      {8, "31/10/2019", "Capital Federal", "Villa Crespo", 1, 1, 70, 70, 159500, "PESOS", "PH", "Alquiler", "08/02/2020", 1},
      {9, "23/12/2019", "Capital Federal", "Parque Patricios", 1, 1, 45, 37, 2400.00, "USD", "Departamento", "Alquiler temporal", "01/04/2020", 1},
      {10, "23/12/2019", "Capital Federal", "Parque Patricios", 1, 1, 45, 37, 89000, "USD", "Casa", "Venta", "05/01/2020", 1},
